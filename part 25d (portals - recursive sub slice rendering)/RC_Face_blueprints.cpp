...
std::vector<FaceBluePrint> vInitFaceBluePrints = {
    ...
    {  8, TYPE_FACE_WALL,  8, true , false },    // portal face
    {  9, TYPE_FACE_WALL,  0, false, false },    // fill out so that roof textures start at index 10

    { 10, TYPE_FACE_ROOF,  0, false, false },
    { 11, TYPE_FACE_ROOF,  1, false, false },
    { 12, TYPE_FACE_ROOF,  2, false, false },
    { 13, TYPE_FACE_ROOF,  3, true , false },
    { 14, TYPE_FACE_ROOF,  4, false, false },
    { 15, TYPE_FACE_ROOF,  5, false, false },
    { 16, TYPE_FACE_ROOF,  6, true , false },
...
//    { 20, TYPE_FACE_ROOF,  3, true , false },    // for testing transparent ceilings
