...
//
// Implementation of part 14 - b: variable height walls, improved texturing
//
// Joseph21, april 3, 2022
//
// Dependencies:
...
/* Short description
   -----------------
   This implementation is a follow up of implementation part 14a. See the description of that implementation as well (and check on
   ...
   The wall texturing is improved in this implementation: previously the texture was stretched over the total height of a wall
   segment. For walls of height 1 this wasn't even visible, but  walls with height > 1 it's less esthetically pleasing.

   This version b of part 14 offers the choice between stretched texturing (as it was before) or non stretched texturing of walls.
   This choice is controlled by the constant STRETCHED_TEXTURING. A little adaptation was done in the rendering code to accommodate
   this improvement.
