...
//
// Implementation of part 24 h - small changes & improvements, refactoring finalized
//
...
/* Short description
   -----------------
   This implementation is a follow up of implementation part 24 g. See the description of that implementation as well (and check on
   ...
   This version is the finalization of that refactoring exercise. A number of small changes and improvements have been implemented herein:
     + The blueprint typedefs are moved from the blueprint files to the RC_MapCell and RC_Face headers
...
public:
    ...
    typedef struct sIntersectInfo {
        ...
        bool bHorizHit = false;          // along a horizontal grid line?
    } IntersectInfo;
