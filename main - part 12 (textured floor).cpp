...
//
// Implementation of part 11 & 12 (textured floor)
//
...
//   *  sprite files for texturing walls and floor - use your own .png files and adapt in OnUserCreate()

/* Short description
   -----------------
   This implementation is the follow up of implementation part 10. See the description of that implementation as well (and check on
...
public:
    bool OnUserCreate() override {
        ...
        // load sprites for texturing the walls and floor
        pWallSprite  = new olc::Sprite( "sprites/wall01.png" );
        pFloorSprite = new olc::Sprite( "sprites/floor3.png" );
        ...
        for (int x = 0; x < ScreenWidth(); x++) {
            ...
            for (int y = 0; y < ScreenHeight(); y++) {
                if (y < nWallCeil) {                           // ========== render ceiling ====================
                    ...
                    // calculate the position from the distance and the view angle + player angle
                    ...
                    // calculate the sample coordinates for that position, by subtracting the
