...
//
// Implementation of part 24 c - isolated (in separate module) RC_MapCell.h and .cpp
//
...
/* Short description
   -----------------
   This implementation is a follow up of implementation part 24 b. See the description of that implementation as well (and check on
   ...
   All the code concerning the RC_MapCell class and derivatives is put into a separate module RC_Face.
 */
