...
void RC_FaceAnimated::SetState( int newState ) {
    state = newState;
    switch ( state ) {
        case ANIM_STATE_CLOSED : tileX = 0; tileY = 0; fTimer = 0.0f; fTickTime = 0.0f; nCounter = 0; nNrFrames = 1; break;
        case ANIM_STATE_OPENED : tileX = 7; tileY = 0; fTimer = 0.0f; fTickTime = 0.0f; nCounter = 0; nNrFrames = 1; break;
