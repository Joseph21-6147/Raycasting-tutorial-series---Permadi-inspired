...
// ==========/  convenience functions for in range checking /==============================

bool is_in_range( int   nTest, int   nLow, int   nHgh ) { return (nLow <= nTest && nTest < nHgh); }
bool is_in_range( float fTest, float fLow, float fHgh ) { return (fLow <= fTest && fTest < fHgh); }
